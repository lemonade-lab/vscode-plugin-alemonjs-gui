...
export default function App({
  ...
  return (
    <section className="relative h-full flex flex-col gap-2 shadow-content py-2 select-none">
        ...
        <div className="md:flex-1 flex flex-col gap-2 py-2 border-y px-2 border-[var(--vscode-sidebar-border)]">
          ...
          <div className="flex flex-row justify-between">
            ...
            <div className="flex flex-row gap-2 items-center">
              ...
              <button className="px-2 flex items-center cursor-pointer rounded-md py-1 hover:bg-[var(--vscode-activityBar-background)]">
                删除
              </button>
            </div>
          </div>
